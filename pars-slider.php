...
Description: 'by this plugin you can make a Jquery Slider , Simple easy and fast<br> by this code you can show Slider : <?php if(function_exists('pars_slider')){ pars_slider(); } ?>'
Version: 0.6
